...
@section('Barra')
    <div class="container-fluid">
            <h1 class="mt-5 mb-5"><center> LLENAR ANTES DE ENTREGAR LAS AYUDAS</center></h1>
        <div class="row  justify-content-center h-100">
            ...
            <form action="{{route('registro')}}" method="POST">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" class="form-control" name="lider" value="{{old('lider')}}">
                    </div>
                    @error('lider')
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                       CAMPO OBLIGATORIO
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="number" class="form-control" name="familia" value="{{old('familia')}}">
                     </div>
                     @error('familia')
                     <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        CAMPO OBLIGATORIO
